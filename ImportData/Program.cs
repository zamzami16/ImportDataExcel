...
namespace OpenXMLDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //System.Data.DataTable data = p.ExtractExcel(@"D:\KERJA\AXATA\ImportDataExcel\ImportDataExcel\bin\TestDataTable.xlsx");
            System.Data.DataTable data = EXcel2DataSet.MyExcelData(@"D:\KERJA\AXATA\ImportDataExcel\ImportDataExcel\bin\TestDataTable.xlsx");
            Console.ReadLine();
        }

        public System.Data.DataTable ExtractExcel(string fullPath)
        {
            var excelFileToImport = fullPath;

            //Create a new DataTable.
            System.Data.DataTable dt = new System.Data.DataTable();

            //Open the Excel file in Read Mode using OpenXML
            using (SpreadsheetDocument doc = SpreadsheetDocument.Open(excelFileToImport, false))
            {
                WorksheetPart titlesWorksheetPart = GetWorksheetPart(doc.WorkbookPart, "Table2");
